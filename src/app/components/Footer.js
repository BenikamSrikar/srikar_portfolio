    ...
    <footer className="w-full bg-[#0a0a0c] border-t border-zinc-800/80 pt-16 pb-8 relative overflow-hidden text-zinc-300">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 items-center text-center md:text-left mb-12">
          ...
          <div className="flex flex-col items-center md:items-start space-y-4">
            <h2 className="font-black text-xl md:text-3xl tracking-tighter flex items-center text-white cursor-default uppercase italic">
              ...
              <span>Benikam</span>
              <span className="ml-1 text-orange-500">Srikar</span>
          ...
          <div className="flex flex-col items-center md:items-end space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/benikam-srikar" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:bg-orange-600 hover:text-white hover:border-orange-600 transition-all duration-300">
                <Github size={18} />
              </a>
              <a href="https://linkedin.com/in/benikam-srikar" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:bg-orange-600 hover:text-white hover:border-orange-600 transition-all duration-300">
                <Linkedin size={18} />
              </a>
              <a href="mailto:benikamsrikar06@gmail.com" className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:bg-orange-600 hover:text-white hover:border-orange-600 transition-all duration-300">
                <Mail size={18} />
              </a>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-zinc-800 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 relative">
          ...
          <button 
            onClick={scrollToTop}
            className="md:absolute md:left-1/2 md:-translate-x-1/2 md:-top-5 w-10 h-10 bg-zinc-900 border border-zinc-800 rounded-full flex items-center justify-center text-zinc-400 hover:text-orange-400 hover:border-orange-400 transition-all duration-300 hover:-translate-y-2 shadow-sm"
          >
            <ArrowUp size={16} />
          </button>
        </div>
