...
export default function Skills() {
  ...
  useEffect(() => {
    ...
    // ── Initial state: tech stack centered and visible, soft skills completely hidden ─────
    gsap.set(techStack, { scale: 1, borderRadius: '24px', transformOrigin: 'center center' });
    gsap.set(softSkills, { opacity: 0, y: '100%', x: 0 }); // Completely hidden off-screen below
    gsap.set(creativeSkills, { opacity: 0, y: '100%', x: 0 }); // Completely hidden off-screen below
    gsap.set(titleBar, { opacity: 1 }); // Show tech stack chrome immediately
    gsap.set(bottomBar,{ opacity: 1 });
    gsap.set(softTitleBar, { opacity: 0 }); // Soft skills chrome hidden initially
    ...
    // PHASE 0→0.15: Hold tech stack view (user sees only tech stack)
    tl.to({}, { duration: 0.15 }, 0);

    // PHASE 0.15→0.45: Soft skills slides in from bottom to top
    tl.to(softSkills, {
      opacity: 1,
      y: '10%', // Slide from bottom but stop before fully covering, leaving top gap
      duration: 0.3,
      ease: 'power2.out',
    }, 0.15);

    // PHASE 0.25→0.45: Soft skills chrome fades in as it slides
    ...
    // PHASE 0.45→0.75: Creative skill stack slides in and overlaps soft skills card
    tl.to(creativeSkills, {
      opacity: 1,
      y: '20%', // Sits slightly lower than soft skills to create overlapping stack
      duration: 0.3,
      ease: 'power2.out',
    }, 0.45);

    // PHASE 0.55→0.75: Creative skills chrome fades in
    ...
    // PHASE 0.75→1.0: Hold final view
    ...
    >
      ...
      >
        ...
        >
          ...
          >
          {/* Window title bar — hidden at start, fades in as zoom out completes */}
          <div
            ref={titleBarRef}
          ...
          {/* Skill grid — always visible, this is what the user sees zoomed in */}
        ...
        <div
          ...
          className="absolute inset-0 w-full h-full flex flex-col overflow-hidden"
          style={{
            background: 'linear-gradient(135deg, #dbeafe 0%, #e0e7ff 50%, #ede9fe 100%)', // Same as tech stack
            boxShadow: '0 8px 40px rgba(37,99,235,0.16), 0 2px 8px rgba(37,99,235,0.10)',
            border: '2px solid #bfdbfe', // Same as tech stack
            borderRadius: '24px',
          }}
        >
          {/* Window title bar */}
          ...
          <div className="p-5 md:p-8 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-5">
            ...
            >
              ...
              <p className="text-[11px] text-slate-600 leading-relaxed">
                Clear articulation of concepts to stakeholders
              </p>
            </div>
            ...
            >
              ...
              <p className="text-[11px] text-slate-600 leading-relaxed">
                Active team participation and collaboration
              </p>
            </div>
            ...
            >
              ...
              >
                <span
                  ...
                  style={{ background: '#e8f0fe' }}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path></svg>
                </span>
                <span className="text-xs font-black uppercase tracking-widest text-slate-700">
                  Problem Solving
                </span>
            ...
            >
              ...
              >
                <span
                  ...
                  style={{ background: '#e8f0fe' }}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle></svg>
                </span>
                <span className="text-xs font-black uppercase tracking-widest text-slate-700">
                  Teamwork
                </span>
              ...
              <p className="text-[11px] text-slate-600 leading-relaxed">
                Collaborative mindset for collective goals
              </p>
            </div>
            ...
            >
              ...
              >
                <span
                  ...
                  style={{ background: '#e8f0fe' }}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline></svg>
                </span>
                <span className="text-xs font-black uppercase tracking-widest text-slate-700">
                  Adaptability
                </span>
              ...
              <p className="text-[11px] text-slate-600 leading-relaxed">
                Quick learner with evolving requirements
              </p>
            </div>
            ...
            >
              ...
              >
                <span
                  ...
                  style={{ background: '#e8f0fe' }}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2a3 3 0 0 0-3 3v1H6a3 3 0 0 0-3 3v12a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3V9a3 3 0 0 0-3-3h-3V5a3 3 0 0 0-3-3z"></path><circle cx="12" cy="17" r="1"></circle></svg>
                </span>
                <span className="text-xs font-black uppercase tracking-widest text-slate-700">
                  Leadership
                </span>
              ...
              <p className="text-[11px] text-slate-600 leading-relaxed">
                Initiative to guide and mentor team members
              </p>
            </div>
            ...
            >
              ...
              <p className="text-[11px] text-slate-600 leading-relaxed">
                Logical analysis and thoughtful decision making
              </p>
            </div>
          </div>
        ...
        >
          ...
          <div className="p-5 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
            ...
            >
              ...
              >
                <span
                  className="flex items-center justify-center w-6 h-6 rounded-md text-amber-700 bg-amber-100"
                >
                  <Box size={14} />
                </span>
                <span className="text-xs font-black uppercase tracking-widest text-slate-700">
            ...
            >
              ...
              >
                <span
                  className="flex items-center justify-center w-6 h-6 rounded-md text-violet-700 bg-violet-100"
                >
                  <Film size={14} />
                </span>
                <span className="text-xs font-black uppercase tracking-widest text-slate-700">
            ...
            >
              ...
              >
                <span
                  className="flex items-center justify-center w-6 h-6 rounded-md text-pink-700 bg-pink-100"
                >
                  <Palette size={14} />
                </span>
                <span className="text-xs font-black uppercase tracking-widest text-slate-700">
            ...
            >
              ...
              >
                <span
                  className="flex items-center justify-center w-6 h-6 rounded-md text-emerald-700 bg-emerald-100"
                >
                  <Scissors size={14} />
                </span>
                <span className="text-xs font-black uppercase tracking-widest text-slate-700">
